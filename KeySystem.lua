...
_G.Scripts = "discord.gg/rvnKZH9nFx"
...
if _G.Scripts[game.gameId] then
    ...
    task.wait(.7)
    TextLabel.Text = game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    Tween:Create(TextLabel, TweenInfo.new(.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()
